...
<div id="wrapper">
    ...
    <header>
        ...
        <div class="container">
            ...
            <div class="row nomargin">
                <div class="span4">
                    <div class="logo">
                        <h1><a href="index.html"><i class="icon-tint"></i> PRACTIPASTA </a></h1>
                    </div>
                </div>
                <div class="span8">
                        ...
                        <div class="navigation">
                            <nav>
                                <ul class="nav topnav">
                                    ...
                                    <li class="dropdown">
                                        <a href="#">Portafolio <i class="icon-angle-down"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown">
                                        <a href="#">Galeria <i class="icon-angle-down"></i></a>
                                        <ul class="dropdown-menu">
    ...
    <section id="intro">
        <div class="intro-content">
            <h2>Bienvenidos a Practipasta!</h2>
            <h3>Distribuidora de alimentos</h3>
            <div>
                <a href="#content" class="btn-get-started scrollto">Informacion</a>
            </div>
        </div>
    </section>
    <!-- /section intro -->
                ...
                <div class="span12">
                    <div class="cta-box">
                        <div class="row">
                            <div class="span8">
                                <div class="cta-text">
                                    <h2>Solo por hoy <span>tiempo</span> limitado</h2>
                                </div>
                            </div>
                            <div class="span4">
                                <div class="cta-btn">
