...
<head>
    ...
    <!-- Plugins css-->
    <link href="style/min/select2.min.css" rel="stylesheet" type="text/css" />
    <link href="style/min/dropzone.min.css" rel="stylesheet" type="text/css" />
    <link href="style/css/quill.core.css" rel="stylesheet" type="text/css" />
    <link href="style/css/quill.snow.css" rel="stylesheet" type="text/css" />
...
<!-- App js -->
<script src="assets/min/vendor.min.js"></script>

<!-- Select2 js-->
<script src="style/min/select2.min.js"></script>
<!-- Dropzone file uploads-->
<script src="style/min/dropzone.min.js"></script>

<!-- Quill js -->
<script src="style/min/quill.min.js"></script>

<!-- Init js-->
<script src="style/js/form-fileuploads.init.js"></script>

<!-- Init js -->
<script src="style/js/add-product.init.js"></script>
